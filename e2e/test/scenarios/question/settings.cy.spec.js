...
describe("scenarios > question > settings", () => {
  ...
  describe("column settings", () => {
    ...
    it("should change to column formatting when sidebar is already open (metabase#16043)", () => {
      ...
      cy.findByTestId("TableInteractive-root").findByText("Subtotal").click(); // open subtotal column header actions
      ...
      cy.findByTestId("TableInteractive-root").findByText("Created At").click(); // open created_at column header actions
